	...
	return (
		<div className="max-w-full mx-auto p-6 bg-white dark:bg-gray-800 rounded-xl shadow-2xl border border-pink-200 dark:border-pink-900/50 space-y-8 lg:p-12 xl:p-16">
			...
			<div className="space-y-6 lg:space-y-8">
				<div>
					<label className="block text-sm lg:text-base font-medium text-gray-700 dark:text-gray-300 mb-2">Wallet ID</label>
					<input
						type="text"
				...
				{isAddMoney ? (
					<div>
						<label className="block text-sm lg:text-base font-medium text-gray-700 dark:text-gray-300 mb-2">Amount to Add</label>
						<input
							type="number"
							value={rawBalance}
					...
					<div>
						<label className="block text-sm lg:text-base font-medium text-gray-700 dark:text-gray-300 mb-2">Update Status</label>
						<select
							value={status}
