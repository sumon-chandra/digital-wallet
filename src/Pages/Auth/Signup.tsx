		...
		<div className="flex items-center justify-center min-h-screen bg-background">
			<Card className="w-full max-w-md bg-card border border-input rounded-2xl shadow-xl p-6">
				<CardHeader className="text-center">
					<CardTitle className="text-3xl md:text-4xl font-extrabold text-primary mb-2">Create Account</CardTitle>
					<p className="text-muted-foreground text-sm md:text-base">Welcome! Fill in the form to create your account.</p>
				</CardHeader>
				...
				<CardContent>
					...
					<p className="text-center text-sm text-muted-foreground mt-6">
						...
						<Link to="/login" className="text-primary font-semibold underline hover:text-primary/80 transition-colors duration-300">
							Login
						</Link>
					</p>
				</CardContent>
