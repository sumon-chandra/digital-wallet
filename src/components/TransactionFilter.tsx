			...
			<div className="grid grid-cols-1 md:grid-cols-5 gap-4">
				...
				<div className="md:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-4">
					...
					<div className="relative">
						...
						/>
						<label className="absolute -top-2 left-2 px-1 text-xs bg-[var(--card)] text-[var(--muted-foreground)]">Start Date</label>
					</div>
					...
					<div className="relative">
						...
						<input
							...
							className="w-full pl-10 border border-[var(--input)] rounded-lg px-4 py-3 bg-[var(--background)] text-[var(--foreground)] focus:ring-2 focus:ring-[var(--ring)] focus:border-transparent outline-none transition-all duration-200"
						/>
						<label className="absolute -top-2 left-2 px-1 text-xs bg-[var(--card)] text-[var(--muted-foreground)]">End Date</label>
					</div>
				</div>
